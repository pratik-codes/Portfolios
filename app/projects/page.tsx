          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredProfessionalProjects.map((project, index) => (
                ...
                >
                  <div className="h-full text-sm border border-green-500/30 rounded-lg p-4 bg-black/20 backdrop-blur-sm hover:bg-green-900/20 transition-colors flex flex-col">
